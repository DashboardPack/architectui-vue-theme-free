          ...
          <div class="modal-dialog w-100">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <div class="mb-3" id="exampleInputGroup12" label-for="exampleInput12">
                  <b-form-input id="exampleInput12" type="text" required placeholder="Enter username...">
                  </b-form-input>
                </div>
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3" id="exampleInputGroup3" label-for="exampleInput3">
                      <b-form-input id="exampleInput3" type="password" required placeholder="Repeat password...">
                      </b-form-input>
                    </div>
                  </div>
                </div>
              ...
              <div class="modal-footer d-block text-center">
                <b-button variant="primary" class="btn-wide btn-pill btn-shadow btn-hover-shine" size="lg"
                  >Create Account
                </b-button>
              </div>
            </div>
