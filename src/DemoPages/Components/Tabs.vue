        ...
        <b-row>
          ...
          <b-col md="6">
            <b-card class="mb-3" no-body>
              ...
              <b-tabs pills card nav-class="nav-justified">
                <b-tab title="Tab 1" active>
                  <p>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop
                    publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                </b-tab>
              ...
              <b-tabs card>
                ...
                <b-tab title="Profile">
                  <p>Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid. 
                    Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan.</p>
                </b-tab>
            ...
            <b-card class="mb-3" no-body>
              ...
              <b-tabs pills card vertical>
                <b-tab title="First" active>
                  <p>Vertical tabs are useful when you have limited horizontal space but sufficient vertical space.</p>
                  <p>This is the content of the first tab in vertical orientation.</p>
                </b-tab>
                <b-tab title="Second">
                  <p>Second tab content goes here. The vertical layout makes it easy to add more tabs without 
                    worrying about horizontal space constraints.</p>
                </b-tab>
                <b-tab title="Third">
                  <p>Third tab with some different content. Vertical tabs provide a clean and organized 
                    way to present tabbed content.</p>
                </b-tab>
              </b-tabs>
            </b-card>
          </b-col>
