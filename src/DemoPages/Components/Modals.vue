        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p>
                This is a large modal with more content space. You can add forms, tables, or any other content here.
              </p>
            </div>
            <div class="modal-footer">
